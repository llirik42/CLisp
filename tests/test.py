...
def test_with_path_env(run_translator):
    test_files = os.environ.get('TEST_FILES', '').split(os.pathsep)
    for file_path in test_files:
        ...
        file_path_raw = Path(file_path).relative_to(CASES_PATH).with_suffix("")
